		...
		<div>
			<ReactToPrint content={() => this.componentRef}>
				<PrintContextConsumer>
					{({ handlePrint }) => <Button onClick={handlePrint} {...props} />}
				</PrintContextConsumer>
			</ReactToPrint>
			<TranskripTarunaDOM innerRef={(el) => (this.componentRef = el)} />
		</div>
	);
}
